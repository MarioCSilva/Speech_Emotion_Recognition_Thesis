...
\definecolor{LightCornflowerBlue}{RGB}{65, 190, 228}

\newcommand{\bottomrulec}{
	\arrayrulecolor{gray!25}\specialrule{\belowrulesep}{0pt}{0pt}
	\arrayrulecolor{black}\specialrule{\heavyrulewidth}{0pt}{0pt}
	\arrayrulecolor{black}
}
\newcommand{\midrulec}{%
	\arrayrulecolor{gray!25}\specialrule{\aboverulesep}{0pt}{0pt}
	\arrayrulecolor{black}\specialrule{\lightrulewidth}{0pt}{\belowrulesep}
}
\newcommand{\toprulec}{%
	\arrayrulecolor{black}\specialrule{\lightrulewidth}{\aboverulesep}{0pt}
	\arrayrulecolor{gray!25}\specialrule{\belowrulesep}{0pt}{0pt}
	\arrayrulecolor{black}
}
\newcommand{\midrulecb}{%
	...
	\arrayrulecolor{LightCornflowerBlue}\specialrule{\aboverulesep}{0pt}{0pt}
	\arrayrulecolor{black}
}
...
\include{chapters/2_state_of_the_art.tex}
\include{chapters/3_methodology.tex}
\include{chapters/4_1_datasets.tex}
\include{chapters/4_2_preprocessing.tex}
\include{chapters/4_3_traditional.tex}
\include{chapters/4_4_deep_learning.tex}
\include{chapters/4_5_discussion.tex}
\include{chapters/5_data_stratification.tex}
\include{chapters/6_video_conf_ser.tex}
