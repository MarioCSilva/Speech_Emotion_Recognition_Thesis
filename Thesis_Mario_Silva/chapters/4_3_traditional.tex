...
\begin{table}[H]
	...
	\begin{tabular}{lrrr}
		...
		\acl{cfs} & 98 & 57.87$\pm$1.07 & 7.89 \\
		\begin{tabular}{@{}l@{}}\acl{cfs} \&\\Backward selection\end{tabular} & 33 & 59.12$\pm$1.05 & 4.29\\
		\bottomrule
	\end{tabular}
\end{table}
...
Overall, the \ac{xgb} provides a powerful model that has several advantages:
