...
\Title{\selectlanguage{portuguese}Avaliação Multimodal de Dados Afetivos em Sessões de Videoconferência}
...
\Title{\selectlanguage{english}Multimodal Evaluation of Affective Data in Videoconference Sessions}
...
\Abstract{Palavras Chave}{Computação Afetiva, Processamento de Voz, Reconhecimento de Emoções, Multimodalidade, Aprendizagem Automática}
...
\Abstract{Keywords}{Affective Computing, Voice Processing, Emotion Recognition, Multimodality, Machine Learning}
